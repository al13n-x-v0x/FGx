...
const CATEGORIES = [
  ...
  {
    name: '🖐️ Socials',
    description: 'Fun interactions with other members.',
    commands: [
      { name: '/social slap', desc: 'Give someone a slap (+11 more: clap, hug, boop, high-five...)' },
      { name: '/social stats', desc: 'Your interaction stats' },
      { name: '/social top', desc: 'Leaderboard for an interaction type' },
